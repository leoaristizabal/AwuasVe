...
const Nosotros = () => {
    return (
        <div>
            <section>
                <div className="max-w-[1320px] lg:mx-auto lg:mt-20 mx-6 my-10 flex flex-col lg:flex-row bg-orange1 bg-opacity-75  bg-center rounded-lg shadow-xl">
                    ...
                    <div className="w-full lg:w-1/2 py-12 lg:px-12 px-3">
                        <div className="relative w-fit px-8 py-2 flex items-center justify-center">
                            <span className='bg-blue1 rounded-md bg-opacity-90 absolute w-full h-full z-10'>
                            </span>
